...
faq:
  - question: "Qu'est-ce que la transformation agentique ?"
    answer: "La transformation agentique est la réorganisation des processus, des métiers et de la gouvernance d'une entreprise par des agents IA autonomes. Contrairement à la transformation digitale qui outille les humains, elle délègue des chaînes complètes de décision et d'exécution à des agents IA — tout en gardant l'humain au contrôle et l'entreprise propriétaire de ses actifs."
  - question: "Quelle différence entre transformation digitale et transformation agentique ?"
    answer: "La transformation digitale outille les humains avec des logiciels (ERP, CRM, cloud). La transformation agentique réorganise l'entreprise avec des agents IA qui prennent en charge des chaînes de travail entières sous supervision humaine. Le périmètre passe de la tâche isolée à la chaîne complète, et l'expert métier passe d'utilisateur d'outil à validateur au centre du système."
  - question: "Pourquoi la transformation digitale ne suffit plus ?"
    answer: "Parce qu'elle n'a pas transformé les processus. 70% des projets de transformation digitale n'atteignent pas leurs objectifs, 82% dépassent leur budget initial, et 91% des entreprises françaises déclarent avoir eu des difficultés. Les entreprises ont déployé des outils sans changer leurs processus — l'IA générative amplifie désormais le gap entre l'outil et le résultat opérationnel."
  - question: "Qu'est-ce que le framework ICPC ?"
    answer: "ICPC est l'acronyme d'Identifier, Cadrer, Produire, Capitaliser. C'est la méthode GenieFactory pour structurer une transformation agentique projet par projet : identifier les cas d'usage priorisés, cadrer métier/tech/direction sur le même périmètre, produire en conditions réelles avec validation humaine, et capitaliser la connaissance dans un Knowledge Graph propriétaire."
  - question: "Qu'est-ce qu'un Knowledge Graph dans la transformation agentique ?"
    answer: "Le Knowledge Graph est la mémoire organisationnelle de l'entreprise. Il transforme les savoirs tacites (dans la tête des experts) en un actif collectif, durable et interrogeable. Il structure les relations entre concepts métier, trace la provenance de chaque connaissance et permet un raisonnement multi-niveaux. Contrairement à un stockage documentaire, c'est un actif propriétaire du client, pas du prestataire."
  - question: "Quelle est la première étape pour démarrer une transformation agentique ?"
    answer: "Identifier un processus métier à fort impact et cadrage clair — pas le plus complexe, le plus démontrable. Formuler le ROI en une phrase avant de toucher à un outil. Si vous ne pouvez pas écrire le ROI en une phrase, ne lancez pas le projet. Puis prévoir la capitalisation dès le départ pour que les apprentissages servent aux projets suivants."
  - question: "Qu'est-ce que la transformation agentique n'est pas ?"
    answer: "Ce n'est pas l'adoption d'outils IA comme ChatGPT ou Copilot (c'est de l'outillage). Ce n'est pas de l'automatisation RPA (c'est du scripting qui reproduit des tâches). Ce n'est pas du consulting IA (c'est du service qui produit des slides, pas du changement structurel). La transformation agentique est un changement de nature : elle supprime le travail invisible de traduction et re-saisie."
  - question: "Pourquoi la propriété des actifs digitaux est-elle centrale dans la transformation agentique ?"
    answer: "Parce que sans propriété du code, des données et de la connaissance, l'entreprise reste dépendante de son prestataire et ne capitalise rien. GenieFactory garantit contractuellement que les actifs créés — code applicatif, Knowledge Graph, modèles fine-tunés — appartiennent au client. C'est ce qui transforme une série de projets en transformation durable."
---
